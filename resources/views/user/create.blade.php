...
<div class="card">
   <div class="card-body">
       <form method="POST" action="{{ route('user.store') }}" >
           ...
           <div class="row mb-3">
               <label for="nomortelp" class="col-md-4 col-form-label text-md-end"> {{ __('Nomor Telepon') }}</label>
                   <div class="col-md-6">
                       <input id="nomortelp" type="tel" class="form-control @error('nomortelp') is-invalid @enderror" name="nomortelp" value="{{ old('nomortelp') }}" required autocomplete="nomortelp" autofocus>
                           @error('nomortelp')
                               <span class="invalid-feedback" role="alert">
                                   <strong>{{ $message }}</strong>
                               </span>
